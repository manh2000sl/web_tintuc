                                ...
                                <table class="table table-hover  table-bordered" style="border: 1px" >
                                    ...
                                    @foreach($topics as $topic)
                                        ...
                                        <tr>
                                            ...
                                            <td >{{$topic->name}}</td>
                                            <td >{{$topic->slug}}</td>
                                            <td> <a class="btn btn-xs btn-primary" role="button" href="{{route('admin.topic.edit',['id'=>$topic->id])}}"><i class="nav-icon fas fa-edit"></i> Edit</a>
                                                <form action="{{route('admin.topic.destroy',['id'=>$topic->id])}}"
