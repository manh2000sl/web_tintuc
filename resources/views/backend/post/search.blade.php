...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Có {{count($posts)}} bài viết </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Home</a></li>
                            <li class="breadcrumb-item active">Danh sách kết quả tin tức</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            @else
                                                <td><span class="badge badge-success"> Hiện </span></td>
                                            @endif
                                            <td> <a class="btn btn-xs btn-primary" role="button" href="{{route('admin.edit',['id'=>$post->id])}}"><i class="nav-icon fas fa-edit"></i> Edit</a>
    ...
    {{--                      <i class="fas fa-ellipsis-v"></i>--}}
    {{--                    </span>--}}
    {{--                                        <dillv class="icheck-primary d-inline ml-2">--}}
