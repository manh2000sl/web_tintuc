...
@push('js')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (request) {
                    ...
                    Swal.fire(
                        ...
                        'Bình luận thành công! Bình luận của bạn sẽ được hiển thị sau khi admin phê duyệt.',
                        'Thành công'
                    )
                }
            })
        ...
        function replyComment(id_comment_parent) {
            var id = id_comment_parent;
        ...
        function submitReplyComment(id_comment_parent){
            var id = id_comment_parent;
            var cmt_rep_ID = '#content-repcmt-' + id;
            var content_rep = $(cmt_rep_ID).val();
            // var form_repcmt = '.form-repcmt-' + id;
